...
var str = 'Loading data from server.' + 'Success.' + 'Preparing data for output.' + '=======BEGIN_OF_THE_MSG=======.' + 'Привет!. ' + 'Меня зовут Дима Муха.' + 'Мне 22 и я из Днепропетровска. ' + 'Я люблю JavaScript, но так было не всегда . ' + 'Начинал я с приготовления автотестов на Java с Junit и Selenium, заправлял это BDD фреймворками и настраивал для них Jenkins. ' + 'Cпустя несколько проектов решил познакомиться с версткой. ' + 'С тех пор перешел на приготовление веб-сайтов, работал с wordpress.' + ' Веду проекты от анализа области и требований заказчика до саппорта. Сейчас я сконцентрирован на JavaScript и производных от него технологиях, использую в работе HTML(HTML5), CSS(CSS3), SAAS, Bootstrap, Gulp ,Vanilla JS и весь MEAN-стек. Всегда стараюсь KISS, DRY, по возможности использовать ES6. Фронтенд мне нравится за близость к конечному пользователю и влияние на его UX. Бекенд за иногда очень увлекательные задачи :). Очень хочу поработать в команде. Hope to see you soon!.' +  '=======END_OF_THE_MSG=======.';
